<template>
  <div class="bg-gray-700 h-screen">
    <div class="flex" style="height: 88vh">
      ...
      <!-- main content -->
      <div
        class="w-full h-full relative overflow-y-scroll flex justify-between"
      >
        <!--Cards-->
        <div>
          <div class="px-3 py-3 flex items-center justify-between"></div>
          <div class="w-full flex justify-between p-3">
            <div class="p-3 w-80 h-60 relative">
              <div
              ...
              <div class="bg-gray-600 w-full h-auto p-5 rounded-lg shadow">
                ...
                <h2 class="text-xs text-white tracking-wide">Liev Tolstói</h2>
              </div>
            </div>
            <div
              class="bg-gray-600 w-full h-auto p-5 rounded-lg shadow mt-1 ml-4"
            >
              <p class="text-white text-base">
                “Toda a diversidade, todo o encanto, toda a beleza da vida é
                feita de sombra e de luz”, escreve Liev Tolstói no romance que
                Fiódor Dostoiévski definiu como “impecável”. Publicado
                originalmente em forma de fascículos entre 1875 e 1877, antes de
                finalmente ganhar corpo de livro em 1877, Anna Kariênina
                continua a causar espanto. Como pode uma obra de arte se parecer
                tanto com a vida? Com absoluta maestria, Tolstói conduz o leitor
                por um salão repleto de música, perfumes, vestidos de renda, num
                ambiente de imagens vívidas e quase palpáveis que têm como pano
                de fundo a Rússia czarista. Nessa galeria de personagens
                excessivamente humanos, ninguém está inteiramente a salvo de
                julgamento: não há heróis, tampouco fracassados, e sim pessoas
                complexas, ambíguas, que não se restringem a fórmulas prontas.
                Religião, família, política e classe social são postas à prova
                no trágico percurso traçado por uma aristocrata casada que, ao
                se envolver em um caso extraconjugal, experimenta as virtudes e
                as agruras de um amor profundamente conflituoso, “feito de
                sombra e de luz”.
              </p>
            </div>
          </div>
          <BaseButtonLink
            ...
            class="my-14 w-64 text-sm ml-24"
          />

          <BaseButtonLink
            name="COMPRAR AUDIOBOOK"
            to="/checkout"
            btn-style="button--stay"
            class="my-14 w-72 text-sm ml-24"
          />
        </div>
      </div>
    </div>
