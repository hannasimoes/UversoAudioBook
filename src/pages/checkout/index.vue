      ...
      >
        ...
        <div>
          <div class="w-full h-96 flex justify-center">
            <div>
              <button
                class="flex items-center justify-center opacity-75 hover:opacity-100 mb-4 bg-transparent border-4 border-gray-200 rounded-full py-2 mt-20 w-72 text-sm"
              >
                <span class="material-icons text-white">
                  add_circle_outline
                </span>
                <p class="text-base text-white font-semibold ml-8">
                  Anna Kariênina
                </p>
              </button>
            </div>
